...
Guidance:
 ...
 - Start simple.  A rule or two.  Log entries for a while until you understand what the impact is & how it works.  Only cut over to other actions when you are comfortable with the results in the log.
